...
class PullRequestEventWebhook(APITestCase):
    def test_opened_simple(self):
        ...
        prs = ChangeRequest.objects.filter(
        ...
        # assert pr.author.email == 'baxterthehacker@users.noreply.github.com'
        # assert pr.author.external_id is None
